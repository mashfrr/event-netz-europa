        ...
        <div className="space-y-8">
          <div className="border-l-4 border-slate-800 pl-6">
            <div className="flex items-start space-x-4">
              <div className="text-2xl font-bold text-slate-800">2020</div>
              <div className="flex-1">
                <h3 className="font-semibold text-gray-900 mb-2">Chat-Gruppe mit Veranstaltungstipps entsteht</h3>
          ...
          <div className="border-l-4 border-slate-800 pl-6">
            <div className="flex items-start space-x-4">
              <div className="text-2xl font-bold text-slate-800">09/2021</div>
              <div className="flex-1">
                <h3 className="font-semibold text-gray-900 mb-2">Professionalisierung</h3>
                <p className="text-gray-700">
          ...
          <div className="border-l-4 border-slate-800 pl-6">
            <div className="flex items-start space-x-4">
              <div className="text-2xl font-bold text-slate-800">10/2023</div>
              <div className="flex-1">
                <h3 className="font-semibold text-gray-900 mb-2">Wechsel des Trägervereins</h3>
                <p className="text-gray-700">
          ...
          <div className="border-l-4 border-slate-800 pl-6">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-gray-900 mb-2">Wachstum und Präsenz auf Events</h3>
                <p className="text-gray-700">
          ...
          <div className="border-l-4 border-slate-800 pl-6">
            <div className="flex items-start space-x-4">
              <div className="text-2xl font-bold text-slate-800">01/2025</div>
              <div className="flex-1">
                <h3 className="font-semibold text-gray-900 mb-2">Neues Team findet sich zusammen</h3>
                <p className="text-gray-700">
          ...
          <div className="border-l-4 border-slate-800 pl-6">
            <div className="flex items-start space-x-4">
              <div className="text-2xl font-bold text-slate-800">Sommer 2025</div>
              <div className="flex-1">
                <h3 className="font-semibold text-gray-900 mb-2">Skalierung des Projekts</h3>
                <p className="text-gray-700">
          ...
          <div className="border-l-4 border-slate-800 pl-6">
            <div className="flex items-start space-x-4">
              <div className="text-2xl font-bold text-slate-800">heute</div>
              <div className="flex-1">
                <h3 className="font-semibold text-gray-900 mb-2">Weiterentwicklung der Formate und Ausbau der Präsenz auf Events</h3>
                <p className="text-gray-700">
