    ...
    <div className="max-w-6xl mx-auto px-8 sm:px-6 md:px-8 py-8">
      ...
      <section className="mb-12">
        ...
        <div className="prose text-gray-700 leading-relaxed space-y-4 text-left">
          ...
          <p>
            Du unterstützt junge Menschen dabei, sich zu engagieren, neue Perspektiven zu gewinnen und ihre Stimme einzubringen.
          </p>
          <p>
            So wirst du Teil einer Bewegung, die Jugend in Europa sichtbarer, lauter und vernetzter macht.
          </p>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="prose text-gray-700 leading-relaxed text-left">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4 text-left">
            ...
            <li>Offizielles Zertifikat als Anerkennung deines Engagements</li>
          </ul>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="prose text-gray-700 leading-relaxed space-y-4 text-left">
          ...
          <p>
            So bist du bestens vorbereitet, um souverän über deine Erfahrungen zu sprechen und unsere Community authentisch zu vertreten.
          </p>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="prose text-gray-700 leading-relaxed space-y-4 text-left">
          ...
          <p>
            Wir freuen uns auf dich und dein Engagement für ein vernetztes Europa!
          </p>
        </div>
      </section>
    </div>
