...
async function testSyncOnce() {
  try {
    console.log('🔄 Testing one-time sync from Monday.com to Supabase...');
    ...
    console.log('\n📋 This demonstrates how the auto-sync works:');
    console.log('- It checks for existing events and updates them');
    console.log('- It creates new events if they don\'t exist');
    console.log('- It keeps Supabase synchronized with Monday.com');
...
// Run one-time sync
testSyncOnce().catch(console.error);
