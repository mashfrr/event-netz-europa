...
async function migrateMinimalData() {
  try {
    console.log('🚀 Starting MINIMAL data migration from Monday.com to Supabase...');
    console.log('📋 This will migrate ALL events using only the most basic columns');
...
// Run the minimal migration
migrateMinimalData().catch(console.error);
