...
async function syncMondayToSupabase() {
  try {
    ...
    console.log('📋 Including registration_deadline (Anmeldefrist) mapping');
    ...
    if (errorCount === 0) {
      ...
      console.log('🎯 Anmeldefrist (registration deadline) is now properly mapped!');
    } else {
      console.log('\n⚠️  Some events had errors. Check if registration_deadline column exists.');
    }
...
console.log('🎯 Anmeldefrist → registration_deadline mapping included');
